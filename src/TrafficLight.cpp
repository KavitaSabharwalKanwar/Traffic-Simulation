...
void TrafficLight::waitForGreen()
{
    ...
    while (true) {
        ...
        if (message == TrafficLightPhase::green) {
            std::cout << "Green Light received " << this->getID() << "\n";
            return;
        }
        else
            std::cout << "Red Light received " << this->getID() << "\n";
    }
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    while (true)
    {
        ...
        if (timeSinceLastUpdate >= cycleDuration) {
            ...
            auto future = std::async(std::launch::async, &MessageQueue<TrafficLightPhase>::send, queue, std::move(message));
            future.wait();
